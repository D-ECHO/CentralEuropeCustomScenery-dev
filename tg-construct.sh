...
then
	geo="--min-lon=14.5 --max-lon=15.0 --min-lat=47.0 --max-lat=47.3"
elif [ $1 -eq 16 ]
then
	geo="--min-lon=8.4 --max-lon=8.8 --min-lat=47.1 --max-lat=47.9"
elif [ $1 -eq 17 ]
then
	geo="--min-lon=7.8 --max-lon=8.8 --min-lat=46.5 --max-lat=47.1"
elif [ $1 -eq 18 ]
then
	geo="--min-lon=7.1 --max-lon=7.8 --min-lat=46.8 --max-lat=47.4"
elif [ $1 -eq 19 ]
then
	geo="--min-lon=7.0 --max-lon=7.8 --min-lat=46.0 --max-lat=46.8"
elif [ $1 -eq 20 ]
then
...
then
	geo="--min-lon=19.0 --max-lon=19.25 --min-lat=50.25 --max-lat=50.50"
elif [ $1 -eq 26 ]
then
	geo="--min-lon=16.0 --max-lon=17.0 --min-lat=48.0 --max-lat=48.5"
elif [ $1 -eq 27 ]
then
	geo="--min-lon=8.8 --max-lon=9.5 --min-lat=49.0 --max-lat=49.8"
elif [ $1 -eq 28 ]
then
	geo="--min-lon=6.5 --max-lon=6.7 --min-lat=49.4 --max-lat=49.8"
elif [ $1 -eq 29 ]
then
	geo="--min-lon=13.0 --max-lon=14.0 --min-lat=52 --max-lat=53"
elif [ $1 -eq 99 ]
then
